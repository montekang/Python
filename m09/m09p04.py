...
PAGE_READWRITE     =     0x04           #PAGE_READWRITE = 0X0000040   
...
def inject( pid, data, parameter = 0 ):
    ...
    arg_address = kernel32.VirtualAllocEx( h_process, 0, len(data), VIRTUAL_MEM, PAGE_READWRITE) #PAGE_EXECUTE_READWRITE
    written = c_int(0)
