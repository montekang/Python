...
print "[*] Check the value for the questions"
print "[*] The address of kernel allocated for the DLL path : 0x%08x" % arg_address
print "[*] The address of location of the LoadLibraryA() function : 0x%08x" % h_loadlib
